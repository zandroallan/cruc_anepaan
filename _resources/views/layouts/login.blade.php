...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container">						
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
							<ul class="navbar-nav ml-auto g-font-size-18 g-font-weight-100">
								<!--li class="nav-item g-mx-10--lg"><a href="{{ route('buscador.index') }}" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover">Buscador</a></li-->
								
								<li class="nav-item g-mx-10--lg">
									<a href="{{ url('/') }}" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover">Inicio</a>
								</li>
								<li class="nav-item g-mx-10--lg">
									<a href="{{ route('videotutorial') }}" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover">Videotutorial</a>
								</li>
                                <li class="nav-item g-mx-10--lg">
                                	<a href="{{ asset('descargas/glosario_terminos.pdf') }}" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover" target="_blank">Glosario de Términos</a>
                                </li>
                            </ul>
                        </div>
				...
				<div class="note note-default " style="text-align:justify">								
					<div class="note-content">
						...
						<p class="r-d-5">                            
							...
							<img src="{{asset('public/img/iconos/chrome.png')}}"> Google Chrome <img src="{{asset('public/img/iconos/mozilla.png')}}"> Mozilla Firefox
						</p>
					</div>
				</div>
			</div>                                    
        ...
        {!! Html::script('public/js/backend/recuperar_password.js'); !!}						
