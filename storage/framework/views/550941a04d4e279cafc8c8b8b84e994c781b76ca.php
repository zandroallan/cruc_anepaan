...
<head>        
    ...
    <body>
			...
			<div class="u-header__section u-header__section--light  g-transition-0_3 g-bg-color-header" data-header-fix-moment-exclude="" data-header-fix-moment-classes="u-shadow-v18 g-py-0">
                <nav class="navbar navbar-expand-lg g-pa-0 g-pt-4 g-pb-4">
                    <div class="container">
                        ...
                        <a href="https://www.chiapas.gob.mx" class="navbar-brand"><img src="<?php echo e(asset('assets/logo/escudo-icono.png')); ?>" alt=""></a>
        ...
        <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-bluegray-opacity-0_1--after " style="height: 130%; background-image: url(<?php echo e(asset('img2/principal.jpg')); ?>)";></div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 g-mb-20 g-mb-0--lg d-none d-sm-none d-md-none d-lg-none d-xl-block">
                        <img class="img-fluid" src="<?php echo e(asset('img2/logo-blanco.png')); ?>" alt="Logo">
                    </div>
...
</html><?php /**PATH /var/cores/c-sircse/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>