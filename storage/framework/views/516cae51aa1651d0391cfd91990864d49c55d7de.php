            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5 p-5">
                        <div class="row">
                            <img alt="Logo" src="<?php echo e(asset('public/img2/saybg.png')); ?>" width="80%" />
                        </div>
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                            <img alt="Logo" src="<?php echo e(asset('public/img2/contratista.jpg')); ?>" width="80%" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
...
</html><?php /**PATH C:\AppServ\apps\sircse\resources\views/auth/login.blade.php ENDPATH**/ ?>