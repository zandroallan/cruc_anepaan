				...
				<div class="row row-sm">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">
						...
						<?php else: ?>
							<div class="row row-xs align-items-center mg-b-20">
								...
								<div class="col-md-9 mg-t-5 mg-md-t-0">
									<?php if($datos->id_sujeto==1): ?> <span class="badge badge-primary">CONTRATISTA</span> <?php else: ?> <span class="badge badge-secondary">SUPERVISOR</span> <?php endif; ?>
								</div>
							</div>
						<?php endif; ?>
					</div>
					...
					<!--div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="id_tipo_persona" id="id_tipo_persona_1" onclick="tipo_persona(this.value);" value="1" <?php echo e($chk_id_tipo_persona_1); ?>>
									<label class="form-check-label" for="id_tipo_persona_1">Física</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="id_tipo_persona" id="id_tipo_persona_2" onclick="tipo_persona(this.value);" value="2" <?php echo e($chk_id_tipo_persona_2); ?>>
				...
				<div class="row row-sm">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<label id="lblrfc" name="lblrfc" class="lblrfc" class="form-control"><?php echo $datos->rfc; ?></label>
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 moral">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<label id="lblrazon_social_o_nombre" name="lblrazon_social_o_nombre" class="lblrazon_social_o_nombre"><?php echo $datos->razon_social_o_nombre; ?></label>
				...
				<div class="row row-sm">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::text('folio_pago_temp', null, ['id'=>'folio_pago_temp', 'placeholder'=>'',  'class'=>'form-control input-sm']); ?>
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::text('fecha_pago_temp', null, ['id'=>'fecha_pago_temp', 'placeholder'=>'',  'class'=>'form-control  fc-datepicker input-sm']); ?>
				...
				<div class="row row-sm">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::text('telefono', null, ['id'=>'telefono', 'placeholder'=>'',  'class'=>'form-control input-sm']); ?>
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::text('correo', null, ['id'=>'correo', 'placeholder'=>'',  'class'=>'form-control input-sm']); ?>
				...
				<div class="row row-sm fisica">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<label id="lblnombre" name="lblnombre" class="lblnombre" class="form-control"><?php echo $datos->nombre; ?></label>
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<label id="lblap_paterno" name="lblap_paterno" class="lblap_paterno" class="form-control"><?php echo $datos->ap_paterno; ?></label>
				...
				<div class="row row-sm fisica">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<label id="lblap_materno" name="lblap_materno" class="lblap_materno" class="form-control"><?php echo $datos->ap_materno; ?></label>
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								...
								<label id="lblcurp" name="lblcurp" class="lblcurp" class="form-control"><?php echo $datos->curp; ?></label>
				...
				<div class="row row-sm fisica">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">
						...
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::select('id_tipo_identificacion', $tipo_identificaciones, null, ['id' => 'id_tipo_identificacion', 'style'=>'width: 100%;', 'class' => 'form-control select2 select-sm']); ?>	
					...
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">
						...
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::text('numero_identificacion', null, ['id'=>'numero_identificacion', 'placeholder'=>'',  'class'=>'form-control input-sm']); ?>
				...
				<div class="row row-sm fisica">
					<div class="col-sm-6 mg-t-20 mg-sm-t-0">						
						<div class="row row-xs align-items-center mg-b-20 fisica">
							...
							<div class="col-md-9 mg-t-5 mg-md-t-0">
								<?php echo Form::select('id_nacionalidad', $nacionalidades, $default_nacionalidad, ['id' => 'id_nacionalidad', 'style'=>'width: 100%;', 'class' => 'form-control select2 select-sm']); ?>	
...
</div><?php /**PATH /var/cores/c-sircse/resources/views/backend/mis-tramites/form.blade.php ENDPATH**/ ?>