		...
		<?php $__env->startSection('styles'); ?>	
			...
			<link href="<?php echo e(asset('dashlead/plugins/select2/css/select2.min.css')); ?>" rel="stylesheet"/>

		<?php $__env->stopSection(); ?>

		<?php $__env->startSection('js'); ?>

			<script src="<?php echo e(asset('dashlead/plugins/jquery-ui/ui/widgets/datepicker.js')); ?>"></script>
			<script src="<?php echo e(asset('dashlead/plugins/select2/js/select2.min.js')); ?>"></script>
			<script src="<?php echo e(asset('dashlead/js/select2.js')); ?>"></script>
			
			<script src="<?php echo e(asset('js/backend/general.js')); ?>"></script>			
			<script src="<?php echo e(asset('js/backend/mis-tramites.js')); ?>"></script>

			<!--Archivos para los documentos de las areas-->
			<script src="<?php echo e(asset('js/backend/filesDoctos/jsDocumentosTools.js')); ?>"></script>	
			<script src="<?php echo e(asset('js/backend/filesDoctos/jsDocumentosLegal.js')); ?>"></script>	
			<script src="<?php echo e(asset('js/backend/filesDoctos/jsDocumentosFinanciera.js')); ?>"></script>	
			<script src="<?php echo e(asset('js/backend/filesDoctos/jsDocumentosTecnica.js')); ?>"></script>	
			
			<!--Archivos para los formularios-->
			<script src="<?php echo e(asset('js/backend/filesForms/jsCombos.js')); ?>"></script>
			<script src="<?php echo e(asset('js/backend/filesForms/mdl_area_legal.js')); ?>"></script>	
			<script src="<?php echo e(asset('js/backend/filesForms/mdl_rep_tec.js')); ?>"></script>
			<script src="<?php echo e(asset('js/backend/filesForms/jsChecks.js')); ?>"></script>	

			<!--Archivos para los form area legal-->
			<script src="<?php echo e(asset('js/backend/filesForms/jsLegal.js')); ?>"></script>

			<script src="<?php echo e(asset('js/backend/filesForms/contacto.js')); ?>"></script>
		...
		<?php $__env->startSection('content'); ?>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<center><embed src="<?php echo e(asset('descargas/LineamientosCS.pdf')); ?>" width="1000" height="550" alt="pdf" /></center>
				</div>			
			</div>
			<?php else: ?>
			<div class="row">
		...
		<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/cores/c-sircse/resources/views/backend/mis-tramites/nuevo-tramite.blade.php ENDPATH**/ ?>