...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group row m-b-15 d-none moral">
			...
			<div class="col-md-9">
				<?php echo Form::text('razon_social_o_nombre', null, ['id'=>'razon_social_o_nombre', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
		...
		<div class="form-group row m-b-15 fisica">
			...
			<div class="col-md-9">
				<?php echo Form::text('curp', null, ['id'=>'curp', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>			
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('rfc', null, ['id'=>'rfc', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15 fisica">
			...
			<div class="col-md-9">
				<?php echo Form::select('id_nacionalidad', $nacionalidades, $default_nacionalidad, ['id' => 'id_nacionalidad', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']); ?>			
	...
	<div class="col-md-6">
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('correo', null, ['id'=>'correo', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15 fisica">
			...
			<div class="col-md-9">
				<?php echo Form::select('id_tipo_identificacion', $tipo_identificaciones, null, ['id' => 'id_tipo_identificacion', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']); ?>			
		...
		<div class="form-group row m-b-15 fisica">
			...
			<div class="col-md-9">
				<?php echo Form::text('numero_identificacion', null, ['id'=>'numero_identificacion', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::password('password', ['id'=>'password', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::password('password_confirmation', ['id'=>'password_confirmation', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
...
</div><?php /**PATH /var/cores/c-sircse/resources/views/frontend/crear-cuenta/form.blade.php ENDPATH**/ ?>