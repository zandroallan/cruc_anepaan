    ...
    <div class="row" id="NoEncontrado" style="display: none;">
    	<div class="col-md-12">
    		<div class="alert-danger mb-3">                                                    
		      	<h3 class="pt-2">
		      		<img src="<?php echo e(asset('img/error.png')); ?>" style="width: 35px; margin-right:15px;"/>
    	...
    	<div class="row pt-4">
    		<div class="col-md-12">
    			<div class="alert-success">                                                    
		          	<h3 class="pt-2">
		          		<img src="<?php echo e(asset('img/accept.png')); ?>" style="width: 35px; margin-right:15px;"/>
...
<?php $__env->startSection('js'); ?>
	<script src="<?php echo e(asset('js/validar/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('script'); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app_valida', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/cores/c-sircse/resources/views/validar/index.blade.php ENDPATH**/ ?>