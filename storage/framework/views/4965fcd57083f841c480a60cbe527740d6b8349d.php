...
<html lang="en">
    <head>        
		...
		<?php echo Html::style('assets/vendor/bootstrap/bootstrap.min.css');; ?>

		<?php echo Html::style('assets/vendor/bootstrap/offcanvas.css');; ?>

		
					
		<!-- CSS Implementing Plugins -->
		<?php echo Html::style('assets/vendor/icon-awesome/css/font-awesome.min.css');; ?>

		<?php echo Html::style('assets/vendor/icon-line-pro/style.css');; ?>

		<?php echo Html::style('assets/vendor/icon-line/css/simple-line-icons.css');; ?>

		<?php echo Html::style('assets/vendor/icon-hs/style.css');; ?>

		<?php echo Html::style('assets/vendor/dzsparallaxer/dzsparallaxer.css');; ?>

		<?php echo Html::style('assets/vendor/dzsparallaxer/dzsscroller/scroller.css');; ?>

		<?php echo Html::style('assets/vendor/dzsparallaxer/advancedscroller/plugin.css');; ?>

		<?php echo Html::style('assets/vendor/animate.css');; ?>

		<?php echo Html::style('assets//vendor/typedjs/typed.css');; ?>

		<?php echo Html::style('assets/vendor/hamburgers/hamburgers.min.css');; ?>

		<?php echo Html::style('assets/vendor/fancybox/jquery.fancybox.css');; ?>

		<?php echo Html::style('assets/vendor/slick-carousel/slick/slick.css');; ?>


		
		<?php echo Html::style('assets/css/unify-core.css');; ?>

		<?php echo Html::style('assets/css/unify-components.css');; ?>

		<?php echo Html::style('assets/css/unify-globals.css');; ?>					
	
		<?php echo Html::style('assets/css/custom.css');; ?>

		<?php echo Html::style('assets/css/personalizado.css');; ?>
    ...
    <body>
			...
			<div class="u-header__section u-header__section--light  g-transition-0_3 g-bg-color-header" data-header-fix-moment-exclude="" data-header-fix-moment-classes="u-shadow-v18 g-py-0">
                <nav class="navbar navbar-expand-lg g-pa-0 g-pt-4 g-pb-4">
                    <div class="container">						
                        ...
                        <a href="https://www.chiapas.gob.mx" class="navbar-brand"><img src="assets/logo/escudo-icono.png" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
							<ul class="navbar-nav ml-auto g-font-size-18 g-font-weight-100">
								...
								<li class="nav-item g-mx-10--lg"><a href="<?php echo e(url('/')); ?>" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover">Inicio</a></li>
								
								<li class="nav-item g-mx-10--lg"><a href="<?php echo e(route('videotutorial')); ?>" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover">Videotutorial</a></li>
							
                                <li class="nav-item g-mx-10--lg"><a href="<?php echo e(asset('descargas/glosario_terminos.pdf')); ?>" class="nav-link g-color-white-opacity-0_9 g-text-underline--hover" target="_blank">Glosario de Términos</a></li>
                            </ul>
       ...
       <!--  <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-bluegray-opacity-0_1--after " style="height: 130%; background-image: url(img2/principal.jpg);"></div>
		...
		<!--<?php echo Html::script('assets/inc/simplescrollup.js');; ?>-->
		<?php echo Html::script('assets/vendor/jquery/jquery.min.js');; ?>

		<?php echo Html::script('assets/vendor/jquery-migrate/jquery-migrate.min.js');; ?>

		<?php echo Html::script('assets/vendor/popper.js/popper.min.js');; ?>

		<?php echo Html::script('assets/vendor/bootstrap/bootstrap.min.js');; ?>		

		<?php echo Html::script('assets/vendor/hs-megamenu/src/hs.megamenu.js');; ?>

		<?php echo Html::script('assets/vendor/dzsparallaxer/dzsparallaxer.js');; ?>

		<?php echo Html::script('assets/vendor/dzsparallaxer/dzsscroller/scroller.js');; ?>

		<?php echo Html::script('assets/vendor/dzsparallaxer/advancedscroller/plugin.js');; ?>

		<?php echo Html::script('assets/vendor/fancybox/jquery.fancybox.min.js');; ?>

		<?php echo Html::script('assets/vendor/slick-carousel/slick/slick.js');; ?>


		<?php echo Html::script('assets/js/hs.core.js');; ?>

		<?php echo Html::script('assets/vendor/typedjs/typed.min.js');; ?>

		<?php echo Html::script('assets/js/components/hs.header.js');; ?>

		<?php echo Html::script('assets/js/helpers/hs.hamburgers.js');; ?>

		<?php echo Html::script('assets/js/components/hs.dropdown.js');; ?>

		<?php echo Html::script('assets/js/components/hs.popup.js');; ?>

		<?php echo Html::script('assets/js/components/hs.carousel.js');; ?>

		<?php echo Html::script('assets/js/components/hs.go-to.js');; ?>						
        ...
        <?php echo Html::script('js/backend/recuperar_password.js');; ?>						
		...
		<script>
			$(document).on('ready', function () {		
				...
				swal({
					// title: '<h2><b> AVISO <b/></h2>',
					html: '<img src="http://apps.shyfpchiapas.gob.mx/sircse/img/cierre_ventanilla_ii.jpg" width="80%" />',
					width: '700px',
					focusConfirm: false,
...
<?php /**PATH /var/cores/c-sircse/resources/views/layouts/login.blade.php ENDPATH**/ ?>