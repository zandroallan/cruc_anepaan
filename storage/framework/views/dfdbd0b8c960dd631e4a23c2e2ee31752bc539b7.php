...
<html lang="es">    
    ...
    <body class="light-theme dark-horizontal">  
        ...
        <div id="global-loader">
            <img alt="Loader" class="loader-img" src="<?php echo e(asset('dashlead/img/loader.svg')); ?>" />
        </div>
        <!-- End Loader -->
        <!-- Page -->
        <div class="page">
                ...
                <div class="container">
                    <div class="main-header-left">
                        ...
                        <a class="main-logo" style="color: #6b0f24; text-transform: none;" href="#">
                            <img src="<?php echo e(asset('img2/sircse.png')); ?>" class="header-brand-img desktop-logo" alt="logo"> Portal Sircse
                                ...
                                <div class="main-notification-list">
                                    <div class="media new">
                                        <div class="main-img-user online">
                                            <img alt="avatar" src="<?php echo e(asset('dashlead/img/contratista.png')); ?>"/>
                                        </div>
        ...
        <!-- Ionicons js-->
        <!-- <script src="<?php echo e(asset('dashlead/plugins/ionicons/ionicons.js')); ?>">  </script>-->
        ...
        <!-- Sticky js-->
        <script src="<?php echo e(asset('dashlead/js/sticky.js')); ?>"></script>
        <!-- Custom js-->
...
</html><?php /**PATH /var/cores/c-sircse/resources/views/layouts/backend.blade.php ENDPATH**/ ?>