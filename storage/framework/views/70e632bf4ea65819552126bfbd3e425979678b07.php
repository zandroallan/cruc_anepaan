...
<?php $__env->startSection('js'); ?>
	<script src="<?php echo e(asset('dashlead/plugins/datatable/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dashlead/plugins/datatable/dataTables.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dashlead/plugins/datatable/dataTables.responsive.min.js')); ?>"></script>

    <script src="<?php echo e(asset('js/backend/general.js')); ?>"></script>
    <script src="<?php echo e(asset('js/backend/mis-observaciones.js')); ?>"></script>
<?php $__env->stopSection(); ?>
	...
	<!--div class="invoice">
		...
		<div class="invoice-content">
			...
			<div class="invoice-company">
				<span class="pull-right hidden-print">
					...
					<?php if($si_o_no==1 ): ?>
				 		...
				 		<?php if($yano==0 ): ?>
							...
							<?php if($en_tiempo!=1): ?>
								<?php echo html_entity_decode(link_to_route('tramites.enviar-solventacion-observacion','<i class="fa fa-paper-plane"></i> Enviar solventacion de observaciones', [$datos->id_ultimo_tramite],['class'=>'btn btn-warning btn-sm', 'aria-expanded'=>'false'])); ?>           
							<?php endif; ?>
						<?php endif; ?>
					<?php endif; ?>
				...
				<?php if($contar_observaciones!=0): ?>
					<?php if($si_o_no==1 ): ?>
						Observaciones <?php if($yano==0 ): ?>-  Tiene hasta el dia <?php echo e($fecha_larga); ?> para solventar <?php endif; ?>
					<?php else: ?>
						Revise periódicamente su correo electrónico proporcionado para avisos y notificaciones del Sistema.<br /> Tiene hasta el dia <?php echo e($fecha_larga); ?> para solventar. Gracias por su atención. <br />
					<?php endif; ?>
				<?php else: ?>
			...
			<?php if($yano==1 ): ?>						
				<div class="note note-green m-b-15">
					<div class="note-icon"><i class="fa fa-check"></i></div>
					<div class="note-content">
						<h5><b>Las solventaciones han sido <strong>Enviadas</b></h5>
						<p> La Secretaría tendrá por recibida una solicitud y comenzará a correr el plazo de treinta días naturales, para que otorgue o niegue la constancia de inscripción, modificación o actualización en el registro de Contratistas o de Supervisores Externos, cuando el solicitante solvente las observaciones o presente la documentación completa con todos los requisitos.</p>
						<p>Todos los seguimientos al trámite se le notificarán a su cuenta en el Portal del contratista y a este correo electrónico.</p>
					</div>						
				</div>						
			<?php endif; ?>	
			...
			<?php elseif($en_tiempo==0 && $status_t==5): ?>
				<div class="note note-yellow m-b-15">
							...
							<div class="note-content">
								<h4 class="m-t-5 m-b-5 p-b-2">Informaci&oacute;n</h4>
								<ul class="m-b-5 p-l-25">
									<li>La fecha limite para solventar sus observaciones ha vencido. Por lo anterior el tramite con folio: <b><?php echo $folio_t; ?></b> y fecha limite de solventaci&oacute;n: <b><?php echo $f_limite; ?></b> ha sido <b>cancelado</b>.</li>
								</ul>
							</div>
						</div>
			<?php endif; ?>			
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/cores/c-sircse/resources/views/backend/mis-observaciones/index.blade.php ENDPATH**/ ?>