<footer class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-20">
            ...
            <div class="col-md-10 text-center text-md-left g-mb-10 g-mb-0--md">
                <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md g-font-weight-300 text-center"><a href="<?php echo $urlComision; ?>" class="g-color-white-opacity-0_8 g-color-white--hover">Sistema de Registro de Contratistas y de Supervisores Externos</a></small>
         		</div>
        </div>
                ...
                <img class="img-fluid" src="img/logo-blanco.png" alt="Logo">
            </div>
