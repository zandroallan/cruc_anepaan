...
class C_Documentacion_II extends Model
{
    use SoftDeletes;
    ...
    public static function get_hijos($id_registro, $id_tipo_tramite, $id_sujeto, $id_tipo_persona, $id_area_especifica, $id_padre, $tec_acredita_tmp)
     {
        ...
        foreach($hijos_1 as $hijo_1){
            $array_hijos1=[];
            $tramite_documento_hijo1=T_Tramite_Documentacion::documentacion_tramite_requerida_tmp($id_registro, $hijo_1->id);
            $array_hijos1=[
                "id"=>$hijo_1->id,
                "tiene_opcionales"=>$hijo_1->tiene_opcionales,
                "obligatorio"=> $hijo_1->obligatorio,
                "subir_n"=>$hijo_1->subir_n,
                "documento"=> $hijo_1->nombre,
                "id_padre"=> $hijo_1->id_padre,
                "id_tramite_documento"=>null,
                "id_tramite_documentacion"=>null,
                "descarga"=>null,
                "subir"=>$hijo_1->subir_documento,
                "tiene_hijos"=>$hijo_1->tiene_hijos,
                "hijos"=>null,
                'desglose'=>null,
                'alias'=>null
            ]; 
            ...
            if ( $hijo_1->subir_n == 1 ) {
                $tramites_documento_hijo1=T_Tramite_Documentacion::documentacion_tramite_requerida_opcional_tmp($id_registro, $hijo_1->id);
                $array_n=[];
                foreach ($tramites_documento_hijo1 as $tramite_documento_hijo_1) {
                    $array_hijos1n= [];
                    $idd1= $tramite_documento_hijo_1->id;
