					...
					<div class="card">
						...
						<div id="collapseOne5" class="collapse show" data-parent="#accordionExample5">
							<div class="card-body">
					    		...
					    		{!! Form::hidden('dlg_id', 0, ['id'=>'dlg_id', 'class'=>'form-control input-sm gui-input']) !!}
					    		{!! Form::hidden('id', 0, ['id'=>'id', 'class'=>'form-control input-sm gui-input']) !!}
					            <div class="row" >
					                <div class="col-md-6">
										<div class="form-group row ">
											<label for="dlg_imss" class="col-form-label tx-12 tx-medium tx-gray-700 col-md-6">Número de registro patronal IMSS*</label>
											<div class="col-md-6">
												{!! Form::text('dlg_imss', null, ['id'=>'dlg_imss', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
												{!! Form::text('dlg_boleta_pago', null, ['id'=>'dlg_boleta_pago', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-6">							
												<div class="input-group date">
													{!! Form::text('dlg_fecha_pago', null, ['id'=>'dlg_fecha_pago', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-6">							
												<div class="input-group date">
													{!! Form::text('dlg_fecha_inicio', null, ['id'=>'dlg_fecha_inicio', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
												</div>							
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
												{!! Form::text('dlg_actividad', null, ['id'=>'dlg_actividad', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
									...
									<div class="col-md-6">  
										<div class="form-group row ">
											...
											<div class="col-md-6">							
												<div class="input-group date">
													{!! Form::text('dlg_rec', null, ['id'=>'dlg_rec', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
												</div>							
										...
										<div class="form-group row ">
											...
											<div class="col-md-6">
												{!! Form::text('dlg_num_constancia', null, ['id'=>'dlg_num_constancia', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-6">
												{!! Form::text('dlg_num_control', null, ['id'=>'dlg_num_control', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-6">							
												<div class="input-group date">
													{!! Form::text('dlg_vigencia_de', null, ['id'=>'dlg_vigencia_de', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
												</div>							
										...
										<div class="form-group row ">
											...
											<div class="col-md-6">							
												<div class="input-group date">
													{!! Form::text('dlg_vigencia_al', null, ['id'=>'dlg_vigencia_al', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
												</div>							
						...
						<div id="collapseTwo5" class="collapse" data-parent="#accordionExample5">
							<div class="card-body">
								...
								<form id="frmAddActaConstitutiva" name="frmAddActaConstitutiva" enctype="multipart/form-data" accept-charset="UTF-8">
									@csrf       
									{!! Form::hidden('dlac_id', 0,['id'=>'dlac_id', 'class'=>'form-control input-sm gui-input']) !!}    
									{!! Form::hidden('dlac_id_m', 0,['id'=>'dlac_id_m', 'class'=>'form-control input-sm gui-input']) !!}
									{!! Form::hidden('dlac_id_tramite', $datos->id,['id'=>'dlac_id_tramite', 'class'=>'form-control input-sm gui-input']) !!}
									<div class="row">
										<div class="col-md-6 ">
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_num_escritura', null, ['id'=>'dlac_num_escritura', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">              
													<div class="input-group date">
														{!! Form::text('dlac_fecha_escritura', null, ['id'=>'dlac_fecha_escritura', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_notario_nombre', null, ['id'=>'dlac_notario_nombre', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_notario_numero', null, ['id'=>'dlac_notario_numero', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="col-md-6 "> 
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_num_registro_publico', null, ['id'=>'dlac_num_registro_publico', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_seccion', null, ['id'=>'dlac_seccion', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_ciudad', null, ['id'=>'dlac_ciudad', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													<div class="input-group date">
														{!! Form::text('dlac_fecha_registro_publico', null, ['id'=>'dlac_fecha_registro_publico', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
									...
									<div class="row">
										<div class="col-md-6 ">
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_num_escritura_m', null, ['id'=>'dlac_num_escritura_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">              
													<div class="input-group date">
														{!! Form::text('dlac_fecha_escritura_m', null, ['id'=>'dlac_fecha_escritura_m', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_notario_nombre_m', null, ['id'=>'dlac_notario_nombre_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_notario_numero_m', null, ['id'=>'dlac_notario_numero_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="col-md-6 "> 
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_num_registro_publico_m', null, ['id'=>'dlac_num_registro_publico_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_seccion_m', null, ['id'=>'dlac_seccion_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													{!! Form::text('dlac_ciudad_m', null, ['id'=>'dlac_ciudad_m', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="form-group row ">
												...
												<div class="col-md-8">
													<div class="input-group date">
														{!! Form::text('dlac_fecha_registro_publico_m', null, ['id'=>'dlac_fecha_registro_publico_m', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
								...
								<div class="row">
									<div class="col-md-6 ">
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_nombre', null, ['id'=>'dlrepl_nombre', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}				
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_ap_paterno', null, ['id'=>'dlrepl_ap_paterno', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}				
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_ap_materno', null, ['id'=>'dlrepl_ap_materno', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}				
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_curp', null, ['id'=>'dlrepl_curp', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}			
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_rfc', null, ['id'=>'dlrepl_rfc', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_telefono', null, ['id'=>'dlrepl_telefono', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_correo_electronico', null, ['id'=>'dlrepl_correo_electronico', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_numero_identificacion', null, ['id'=>'dlrepl_numero_identificacion', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_num_registro_publico', null, ['id'=>'dlrepl_num_registro_publico', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_seccion', null, ['id'=>'dlrepl_seccion', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_ciudad', null, ['id'=>'dlrepl_ciudad', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">							
												<div class="input-group date">
													{!! Form::text('dlrepl_fecha_registro_publico', null, ['id'=>'dlrepl_fecha_registro_publico', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
									...
									<div class="col-md-6 ">  
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_ciudad_particular', null, ['id'=>'dlrepl_ciudad_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_calle_particular', null, ['id'=>'dlrepl_calle_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-3">
												{!! Form::text('dlrepl_ext_particular', null, ['id'=>'dlrepl_ext_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="col-md-3">
												{!! Form::text('dlrepl_int_particular', null, ['id'=>'dlrepl_int_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-4">
												{!! Form::text('dlrepl_colonia_particular', null, ['id'=>'dlrepl_colonia_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
											...
											<div class="col-md-3">
												{!! Form::text('dlrepl_cp_particular', null, ['id'=>'dlrepl_cp_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_referencias_particular', null, ['id'=>'dlrepl_referencias_particular', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_num_escritura', null, ['id'=>'dlrepl_num_escritura', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">							
												<div class="input-group date">
													{!! Form::text('dlrepl_fecha_escritura', null, ['id'=>'dlrepl_fecha_escritura', 'placeholder'=>'',  'class'=>'form-control input-sm fc-datepicker']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_notario_nombre', null, ['id'=>'dlrepl_notario_nombre', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
										...
										<div class="form-group row ">
											...
											<div class="col-md-8">
												{!! Form::text('dlrepl_notario_numero', null, ['id'=>'dlrepl_notario_numero', 'placeholder'=>'',  'class'=>'form-control input-sm ']) !!}
