            ...
            <form id="frmRepresentanteTecnico" name="frmRepresentanteTecnico">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_nombre', null, ['id'=>'dtrtec_nombre', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_ap_paterno', null, ['id'=>'dtrtec_ap_paterno', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_ap_materno', null, ['id'=>'dtrtec_ap_materno', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_curp', null, ['id'=>'dtrtec_curp', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <!-- <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_rfc', null, ['id'=>'dtrtec_rfc', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('dtrtec_id_tipo_constancia', [1=>"Propia", 2=>"Ajena"], null, ['id' => 'dtrtec_id_tipo_constancia', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']) !!}           
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_num_constancia', null, ['id'=>'dtrtec_num_constancia', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('dtrtec_reposicion', [0=>"No", 1=>"Si"], null, ['id' => 'dtrtec_reposicion', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']) !!}          
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('dtrtec_id_profesion', $profesiones, null, ['id' => 'dtrtec_id_profesion', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('dtrtec_id_colegio', $colegios_rtecs, null, ['id' => 'dtrtec_id_colegio', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('dtrtec_cedula', null, ['id'=>'dtrtec_cedula', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8">
                            <div class="input-group date">
                                {!! Form::text('dtrtec_fecha_cedula', null, ['id'=>'dtrtec_fecha_cedula', 'placeholder'=>'',  'class'=>'form-control datepicker']) !!}
