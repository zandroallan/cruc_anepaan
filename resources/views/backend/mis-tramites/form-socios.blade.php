				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_nombre', null, ['id'=>'dlscs_nombre', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}				
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_ap_paterno', null, ['id'=>'dlscs_ap_paterno', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}				
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_ap_materno', null, ['id'=>'dlscs_ap_materno', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}				
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_curp', null, ['id'=>'dlscs_curp', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}			
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_rfc', null, ['id'=>'dlscs_rfc', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_telefono', null, ['id'=>'dlscs_telefono', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_correo_electronico', null, ['id'=>'dlscs_correo_electronico', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_numero_identificacion', null, ['id'=>'dlscs_numero_identificacion', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::select('dlscs_id_estado_particular', $estados, null, ['id' => 'dlscs_id_estado_particular', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control', 'onchange'=>'cargar_municipios_general(this, $("#dlscs_id_municipio_particular"));']) !!}			
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_ciudad_particular', null, ['id'=>'dlscs_ciudad_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_calle_particular', null, ['id'=>'dlscs_calle_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-3">
								{!! Form::text('dlscs_ext_particular', null, ['id'=>'dlscs_ext_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
							...
							<div class="col-md-3">
								{!! Form::text('dlscs_int_particular', null, ['id'=>'dlscs_int_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-3">
								{!! Form::text('dlscs_colonia_particular', null, ['id'=>'dlscs_colonia_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
							...
							<div class="col-md-3">
								{!! Form::text('dlscs_cp_particular', null, ['id'=>'dlscs_cp_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								{!! Form::text('dlscs_referencias_particular', null, ['id'=>'dlscs_referencias_particular', 'placeholder'=>'',  'class'=>'form-control input-sm']) !!}
