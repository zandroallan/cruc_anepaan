		...
		<div class="modal-content">
            ...
            <div class="modal-body">                        
                <form id="frmAddEspRtec" name="frmAddEspRtec">
                    @csrf
                    {!! Form::hidden('dtsp_id_tramite_esp', 0, ['id'=>'dtsp_id_tramite_esp', 'class'=>'form-control gui-input']) !!}	
                    {!! Form::hidden('dtsp_id_tramite_rtec', $datos->id, ['id'=>'dtsp_id_tramite_rtec', 'class'=>'form-control gui-input']) !!}	
                    <div class="form-group row m-b-15">
                        <label for="dfcp_id_contador_b_rtec" class="col-form-label col-md-1">Especialidad</label>
                        <div class="col-md-9">
                            {!! Form::select('dtsp_id_especialidad_esp', $colegio_especialidades, null, ['id' => 'dtsp_id_especialidad_esp', 'style'=>'width: 100%;', 'class' => 'default-select2 form-control']) !!}
