                ...
                <div class="container">
                    <div class="main-header-left">
                        ...
                        <a class="main-logo" style="color: #6b0f24; text-transform: none;" href="#">
                            ...
                            <!--img alt="logo" class="header-brand-img desktop-logo" src="{{asset('img2/sircse.png')}}">
                                <img alt="logo" class="header-brand-img icon-logo" src="{{asset('img2/sircse.png')}}">
                                    <img alt="logo" class="header-brand-img desktop-logo theme-logo" src="{{asset('img2/sircse.png')}}">
                                        <img alt="logo" class="header-brand-img icon-logo theme-logo" src="{{asset('img2/sircse.png')}}">
                                        </img>
                                    </img>
                                </img>
                            </img-->
