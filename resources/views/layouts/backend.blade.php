		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<div class="d-flex align-items-center">
				...
				<a href="index.html" class="mr-7">
					<img alt="Logo" src="{{asset('public/assets/media/logos/logo-letter-5.png')}}" class="max-h-30px" />
				</a>
				<!--end::Logo-->
				<!--begin::Dropdown-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="index.html" class="mr-10">
										<img alt="Logo" src="{{asset('public/assets/media/logos/logo-letter-5.png')}}" class="max-h-35px" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Left-->
